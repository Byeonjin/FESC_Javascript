...
import {insertLast} from "../dom/insert.js"
 ...
 const createUserCard = ({id='', name='', email='', website:site=''/*이렇게 사용하면 구조분해 할당하여도 이름을 바꿔서 쓸 수 있다.*/} = {}) => {
  return /* html */`
  <article class="user-card" data-index="user-${id}">
      ...
      <div class="user-resouce-info">
        ...
        <div>
          <a class="user-website" href="http://tiger.com" target="_blank" rel="noopener noreferer">${site}</a>
        </div>
      </div>
...
const arg = {'id': '1', 'name': 'nn', 'email':'dklfaj@afsdkjlds;.ladsfjk;', 'website': 'afjido.com'};
...
const createSpinner = (size = 100, loadingMessage = '유저 정보를 가져오는중...') => {
  ...
  <figure class="loadingSpinner">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin:auto;background:#fff;display:block;" width=${size} height=${size} viewBox="0 0 ${size} ${size}" preserveAspectRatio="xMidYMid">
      <g>
        <animateTransform attributeName="transform" type="rotate" values="360 50 50;0 50 50" keyTimes="0;1" dur="2.7027027027027026s" repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1" begin="-0.14864864864864866s"></animateTransform>
        <circle cx="50" cy="50" r="39.891" stroke="#6994b7" stroke-width="14.4" fill="none" stroke-dasharray="0 300">
          <animate attributeName="stroke-dasharray" values="15 300;30.327747955732814 300;15 300" keyTimes="0;0.5;1" dur="2.7027027027027026s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.06837837837837839s"></animate>
        </circle>
        <circle cx="50" cy="50" r="39.891" stroke="#eeeeee" stroke-width="7.2" fill="none" stroke-dasharray="0 300">
          <animate attributeName="stroke-dasharray" values="15 300;30.327747955732814 300;15 300" keyTimes="0;0.5;1" dur="2.7027027027027026s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.06837837837837839s"></animate>
        </circle>
        <circle cx="50" cy="50" r="32.771" stroke="#000000" stroke-width="1" fill="none" stroke-dasharray="0 300">
          <animate attributeName="stroke-dasharray" values="15 300;24.914658149891455 300;15 300" keyTimes="0;0.5;1" dur="2.7027027027027026s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.06837837837837839s"></animate>
        </circle>
        <circle cx="50" cy="50" r="47.171" stroke="#000000" stroke-width="1" fill="none" stroke-dasharray="0 300">
          <animate attributeName="stroke-dasharray" values="15 300;36.318639482422405 300;15 300" keyTimes="0;0.5;1" dur="2.7027027027027026s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.06837837837837839s"></animate>
        </circle>
      </g>
      
      <g>
        <animateTransform attributeName="transform" type="rotate" values="360 50 50;0 50 50" keyTimes="0;1" dur="2.7027027027027026s" repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1"></animateTransform>
